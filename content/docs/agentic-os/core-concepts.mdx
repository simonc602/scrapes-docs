---
title: "Core concepts"
description: "This page explains the main Agentic OS terms in simple English."
---
...
| Client | A separate workspace for one customer, brand, or project area. |
...
| Local workspace | An Agentic OS workspace signed in to a Team OS server. |
...
Skills can be shared at the root workspace. They can also have client-specific
...
Read [Memory](/docs/memory) before changing memory settings.
...
Start with [Team OS concepts](/docs/team-os/concepts) before setup.
