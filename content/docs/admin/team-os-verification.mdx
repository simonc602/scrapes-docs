...
grants, skill grants, memory import, memory review, search, file sync, revoke
behavior, and Command Centre state.
...
* Command Centre can show the client as synced, changed locally, changed on the
  server, or changed on both sides.
