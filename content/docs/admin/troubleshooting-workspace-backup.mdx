...
| Backup fails with `git` not found | The API image is outdated or does not include Git. | Follow the [Docker Compose update steps](/docs/deploy/docker-compose#start-and-check). If you use a custom image, install Git. |
