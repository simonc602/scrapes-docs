...
| `TEAM_OS_WORKSPACE_BACKUP_REMOTE` | optional | `git@github.com:org/private-backup.git` | Private Git remote for workspace backup. Use only private repositories. |
| `TEAM_OS_GIT_BACKUP_REMOTE` | optional | same shape | Older fallback name for the same backup remote. |
| `TEAM_OS_WORKSPACE_BACKUP_BRANCH` | optional | `main` | Backup branch. Default is `main`. |
| `TEAM_OS_WORKSPACE_BACKUP_USER_NAME` | optional | `Team OS Backup` | Git author name for backup commits. |
| `TEAM_OS_WORKSPACE_BACKUP_USER_EMAIL` | optional | `team-os-backup@example.invalid` | Git author email for backup commits. |
...
services:
  ...
  memory-api:
    ...
    environment:
      ...
      TEAM_OS_WORKSPACE_BACKUP_REMOTE: ${TEAM_OS_WORKSPACE_BACKUP_REMOTE}
      TEAM_OS_WORKSPACE_BACKUP_BRANCH: ${TEAM_OS_WORKSPACE_BACKUP_BRANCH:-main}
    volumes:
