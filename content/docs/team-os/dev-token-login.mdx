...
The dev token is locked to the server-side Team configured for that token. It
cannot be used to switch across Teams. Use email and password login for normal
multi-Team access.
