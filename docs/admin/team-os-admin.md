...
For sync behavior, see [Team OS memory and file sync](https://sites.gitbook.com/preview/site_Nb7fG/team-os/memory-and-sync).
...
Continue with [manual verification](team-os-verification.md).
