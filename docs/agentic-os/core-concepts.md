...
Read [Memory](https://sites.gitbook.com/preview/site_Nb7fG/memory) before changing memory settings.
...
Start with [Team OS concepts](https://sites.gitbook.com/preview/site_Nb7fG/team-os/concepts) before setup.
