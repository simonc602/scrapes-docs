...
* Hints for warnings, notes, and important setup details.
...
* Reusable includes for repeated warnings or command notes.
* Tables for comparison and reference.

Use a block only when it makes the page easier to follow.

## Visual rules

Follow the Command Centre visual direction.

* Use the Agentic OS / Command Centre logo from `.gitbook/assets/`.
...
* Do not redesign the GitBook layout.

For exact tokens, see [Visual style](visual-style.md).
...
* Link to [Team OS](https://sites.gitbook.com/preview/site_Nb7fG/team-os) when explaining hosted team setup.
* Link to [Memory](https://sites.gitbook.com/preview/site_Nb7fG/memory) when explaining search or imports.
* Link to [Troubleshooting](https://sites.gitbook.com/preview/site_Nb7fG/admin/team-os-troubleshooting) when a setup step can fail.
